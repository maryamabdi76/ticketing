        ...
        <div class="row">
          <div class="col-12">
            <div class="card text-right">
                <div class="card-header">{{ __('اضافه کردن نمایش') }}</div>

                <div class="card-body">
                <form method="POST" action="/storeShow">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="event" name="event" class="form-control @error('event') is-invalid @enderror" name="event" required>
                                    <option value="" disabled selected>نام رویداد</option>
                                    @foreach($event as $v)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="salon" name="salon" class="form-control @error('salon') is-invalid @enderror" name="salon" required>
                                    <option value="" disabled selected>نام سالن</option>
                                    @foreach($salon as $v)
                                    <option value="{{$v->id}}">{{$v->name}} - {{$v->locations->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="date" type="text" placeholder="1399-01-01" class="form-control @error('date') is-invalid @enderror" name="date" required autocomplete="date" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="begin" type="text" placeholder="12:00:00" class="form-control @error('begin') is-invalid @enderror" name="begin" required autocomplete="begin" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="end" type="text" placeholder="12:00:00" class="form-control @error('end') is-invalid @enderror" name="end" required autocomplete="end" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="num" type="text" class="form-control @error('num') is-invalid @enderror" name="num" required autocomplete="end" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="text" value="0" class="form-control @error('price') is-invalid @enderror" name="price" autocomplete="price" autofocus>
