                            ...
                            <div class="table-responsive">
                                ...
                                <table class="d-table table text-center table-bordred table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <td>{{$v->title}}</td>
                                        <td>
                                            <a href="/editSlider/{{$v["id"]}}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="ویرایش">
                                                <span class="fa fa-edit"></span>
                                            </a>
                                            <a href="/deleteSlider/{{$v["id"]}}" class="btn btn-danger btn-sm" data-toggle="tooltip" title="حذف" onclick="return confirm('Are you sure you want to delete this item?');" >
