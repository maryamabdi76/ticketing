                            ...
                            <div class="content">
                                <div class="entry-content p-0">
                                    <div class="left text-white">
                                        <span class="date"><?php echo e(str_replace('-','/',str_replace('00:00:00', '', $post->created_at))); ?></span>
                                    </div>
                                </div>
                            ...
                            <div class="widget-1 widget-offer">
                                <div class="offer-body">
                                    <div class="offer-item">
                                        <form class="blog-form"  method="POST" action="<?php echo e(route('addCommentBlog')); ?>">
