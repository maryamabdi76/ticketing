    ...
    <section class="banner-section">
        ...
        <div class="container">
            <div class="banner-content event-content">
                ...
                <p>بلیت خود را برای کنسرت سریعتر از همه و بدون دغدغه تکمیل ظرفیت خریداری کنید.</p>
            </div>
        </div>
    </section>
    <!-- ==========Banner-Section========== -->
            ...
            <div class="row flex-wrap-reverse justify-content-center">
                <div class="col-sm-10 col-md-8 col-lg-3">
                    ...
                    <div class="widget-1 widget-check">
                        <div class="widget-header">
                            <h5 class="m-title">فیلتر</h5> <a href="<?php echo e(route('concert')); ?>" class="clear-check">پاک کردن همه</a>
                        </div>
                        <div class="widget-1-body">
                            <h6 class="subtitle">دسته بندی ها</h6>
                            <form method="post" action="<?php echo e(route('concertgenre')); ?>">
                ...
                <div class="col-lg-9 mb-50 mb-lg-0">
                    <div class="filter-tab tab">
                            ...
                            <div class="filter-main">
                                <div class="left w-100 justify-content-between">
                                    <div class="item mr-0">
                                        ...
                                        <a class="select-b <?php if($sort): ?> active <?php endif; ?>" href="<?php echo e(route('sortShowingConcert')); ?>"onclick="event.preventDefault(); document.getElementById('sortShowing').submit();">
                                            در حال نمایش</a>
                                        <form id="sortShowing" action="<?php echo e(route('sortShowingConcert')); ?>" method="POST" style="display: none;">
                                        <?php echo csrf_field(); ?>
                                            <?php $__currentLoopData = $arrayIdConcerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="tab-area">
                            <div class="tab-item active">
                                <div class="row mb-10 justify-content-center">
                                    <?php if(empty($concerts) || $concerts->count()==0): ?>
                                    ...
                                    <div class="event-grid">
                                        <div class="movie-thumb c-thumb">
                                            <a href="/concert-details/<?php echo e($concert->id); ?>">
                                                <img width="220px" height="300px" src="<?php echo e(asset('/').$concert->Images()->get()->first()->path); ?>" alt="event">
                                            </a>
                                        </div>
                            ...
                            <div class="tab-item">
                                ...
                                <div class="movie-list">
                                    <div class="movie-thumb c-thumb">
                                        <a href="/concert-details/<?php echo e($concert->id); ?>" class="w-75 bg_img" data-background="<?php echo e(asset('/').$concert->Images()->get()->first()->path); ?>">
                                            <img src="<?php echo e(asset('/').$concert->Images()->get()->first()->path); ?>" alt="movie">
                                        </a>
                                    </div>
                                    <div class="movie-content bg-one">
                                        <h5 class="title">
                                        ...
                                        <div class="movie-tags">
                                            <?php $__currentLoopData = $concert->genres()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="#0"><?php echo e($genre->name); ?></a>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                        <div class="release">
                                            <span>تاریخ نمایش : </span> <a href="#0"><?php echo e($concert->date); ?></a>
                                        </div>
                        ...
                        <?php echo e($concerts->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('layouts.bilito.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maktab\Laravel\Ticketing\resources\views/concert/concert.blade.php ENDPATH**/ ?>